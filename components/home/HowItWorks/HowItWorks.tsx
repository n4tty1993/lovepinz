    ...
    <section id="how-it-works" className="bg-[#EDF5EA] py-24">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          <div className="hidden md:block absolute top-10 left-[20%] right-[20%] h-px bg-[#2A7A6F]/20" />
            ...
            return (
              ...
              >
                <div className="relative">
                  ...
                  <span className="absolute -top-2 -right-2 w-7 h-7 rounded-full bg-[#2A7A6F] text-white text-xs font-bold flex items-center justify-center shadow-sm">
                    {step.number}
                  </span>
                </div>
